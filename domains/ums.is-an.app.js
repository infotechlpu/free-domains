...
addSubDomain({
  ...
  subdomain: 'ums', // desired subdomain name
  owner: {
    repo: '<https://github.com/infotechlpu/ums',
    email: '<0xattackers@gmail.com',
  },
  record: {
    CNAME: '<https://infotechlpu.github.io/ums/>', // e.g.: <your-github-account>.github.io
